...
export const MOCK_SHOP_LOOKS: ShopLook[] = [
  {
    ...
    description: 'Tone màu nâu gỗ chủ đạo tạo cảm giác gần gũi.',
    ...
    hotspots: [
      {
        ...
        product: {
          id: 301,
          sku: 'BEE-301',
          slug: 'cozy-knit-throw',
          name: 'Cozy Knit Throw',
          price: 350000,
          categoryId: 5,
          category: 'Textile',
          image: 'https://picsum.photos/id/1025/150/150',
          hoverImage: 'https://picsum.photos/id/1025/150/150',
          isActive: true,
          createdAt: now
        }
      },
      {
        ...
        product: {
          ...
          categoryId: 4,
          category: 'Furniture',
          image: 'https://picsum.photos/id/1078/150/150',
          hoverImage: 'https://picsum.photos/id/1078/150/150',
          isActive: true,
          createdAt: now
        }
      }
  ...
  {
    id: 2,
    name: 'Góc Làm Việc Chill',
    description: 'Tối giản để tập trung, sáng tạo không giới hạn.',
    image: 'https://picsum.photos/id/1065/800/1000',
    hotspots: [
      {
        id: 201,
        x: 40,
        ...
        product: {
          ...
          categoryId: 4,
          category: 'Furniture',
          image: 'https://picsum.photos/id/366/150/150',
          hoverImage: 'https://picsum.photos/id/366/150/150',
          isActive: true,
          createdAt: now
        }
      }
